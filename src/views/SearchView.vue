<template>
  ...
  <main v-else>
    <div
      v-if="searchData.error || !searchData.moviesWithGenres.length"
      class="error"
    >
      ...
      <div v-if="searchData.searchArray" class="container">
        <div class="movie" v-for="data in searchData.moviesWithGenres">
          ...
          <div class="movie-details">
            ...
            <h1 class="title" v-if="data.original_name">
              {{ data.original_name }}
            </h1>
            <p class="date" v-if="data.release_date">
              <span>Year: </span>{{ data.release_date.split("-")[0] }}
            </p>
            <p class="date" v-if="data.first_air_date">
              <span>First Air of Series: </span>{{ data.first_air_date }}
            </p>
